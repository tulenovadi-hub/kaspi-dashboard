...
//
// remaining здесь — это то, что РЕАЛЬНО ЛЕЖИТ НА ПОЛКЕ: из него вычтено и проданное, и
// потенциальное пополнение из основного списка "Отмены при доставке" (поле returning).
