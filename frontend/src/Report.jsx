...
const RED_KEYS = new Set(['cost_of_goods', 'returns', 'cost_of_returns', 'commission', 'delivery', 'taxes', 'marketing', 'packaging', 'other_expenses']);
  ...
  return (
    <div>
      ...
      <div className="report-note">
        ...
        к городу отгрузки, поэтому считаются по всему магазину целиком, а не только по Алматы и Астане. «Упаковка» — сумма категории «Упаковка» из
        раздела «Расходы» (Google Таблица) за тот же месяц; вносится туда вручную, тоже считается по всему магазину целиком.
        ...
        её расход делится между ними поровну; кампании без сохранённой привязки к товару в разбивку не попадают). «Прочие расходы» и «Упаковка» на уровне
