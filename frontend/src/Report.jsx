  ...
  return (
    <div>
      ...
      <div className="report-note">
        ...
        только по продажам с 1 июня 2026 и не позже последней даты, которая есть в загруженном Excel-отчёте Kaspi Pay — так выручка и себестоимость всегда
        считаются за один и тот же период, даже если синхронизация заказов уже успела уйти дальше по датам, чем ваш файл. Таблицы по городам определяются
        по номеру заказа: он совпадает и в Excel-отчёте Kaspi Pay, и в данных заказов Kaspi.
      </div>
    </div>
  );
}
