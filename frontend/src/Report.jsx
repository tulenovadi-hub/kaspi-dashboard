...
const RED_KEYS = new Set(['cost_of_goods', 'returns', 'cost_of_returns', 'commission', 'delivery', 'taxes', 'marketing', 'other_expenses']);
  ...
  return (
    <div>
      ...
      <div className="report-note">
        ...
        к городу отгрузки, поэтому считаются по всему магазину целиком, а не только по Алматы и Астане.
        ...
        её расход делится между ними поровну; кампании без сохранённой привязки к товару в разбивку не попадают). «Прочие расходы» на уровне товара
        не считаются вообще — это расход всего бизнеса, а не конкретного товара, поэтому в разбивке там прочерк.
      </div>
    </div>
  );
}
