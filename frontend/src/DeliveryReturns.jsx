...
const TRACKING_STATUS_LABELS = {
  ...
  // Не код события, а верхнеуровневый orderStatus трекинга: Kaspi по части возвратов не выдаёт
  // ни одного события RETURN_*, и единственный признак — это поле (см. deliveryReturnsSync.js).
