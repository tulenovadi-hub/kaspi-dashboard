        ...
        >
          ...
          {mode !== 'selfbuy' && (
            <div style={{ color: '#6b7690', fontSize: 12, marginTop: usedEstimate ? -4 : -12, marginBottom: 16 }}>
              ...
              и операционные расходы со страницы «Расходы» — категории «Прочие затраты» и «Упаковка» — по датам,
              попавшим в выбранный период. Только то, что фактически загружено и записано, без прогноза за
              недостающие дни.
            </div>
          )}
