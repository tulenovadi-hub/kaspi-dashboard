  ...
  return (
    <div>
      ...
      <div className="report-note">
        ...
        сайта — ничего дополнительно вводить не нужно. Себестоимость товаров в этом отчёте оценивается по FIFO
        (партии от старой к новой), но приблизительно — не учитывает, сколько от каждой партии уже израсходовано
        продажами вне выбранного периода; для точных цифр смотрите «Отчёт» и «Заказы». Каждое нажатие «Сформировать
