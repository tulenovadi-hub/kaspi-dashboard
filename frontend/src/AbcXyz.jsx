        ...
        <div className="card">
          ...
          <div className="abc-legend">
            {selectedCell && ADVICE[selectedCell] ? (
              ...
              <p>
                По строкам — вклад в {basis === 'profit' ? 'прибыль' : 'выручку'}: <b>A</b> — товары,
                дающие первые {t ? t.abcA : 80}% , <b>B</b> — следующие {t ? t.abcB - t.abcA : 15}%,
                <b> C</b> — весь хвост. По столбцам — стабильность недельных продаж:
                <b> X</b> — отклонение до {t ? Math.round(t.xyzX * 100) : 10}%,
                <b> Y</b> — до {t ? Math.round(t.xyzY * 100) : 25}%, <b>Z</b> — больше.
